<div class="interface-image-wrapper style-one">
    <div class="image-one wow pixFadeUp">
        <img src="<?php echo esc_url( $settings['image_one']['url'] ); ?>" data-parallax='{"y"; : 50}' alt="<?php esc_attr__('interface', 'saaspik-addons') ?>">        
    </div>

    <div class="image-two wow pixFadeDown">
        <img src="<?php echo esc_url( $settings['image_two']['url'] ); ?>" data-parallax='{"y"; : -50}' alt="<?php esc_attr__('interface', 'saaspik-addons') ?>">     
    </div>
